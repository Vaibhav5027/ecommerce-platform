...
public class ProductServiceImpl implements ProductService {
  ...
  public ProductResponse getAllProducts(
    ...
    List<ProductDTO> result =
        productPage.stream().map(product -> modelMapper.map(product, ProductDTO.class)).toList();
  ...
  @Override
  public ProductResponse productsByCategory(
    ...
    Page<Product> productPage =
        productRepository.findByCategoryOrderByPriceDesc(category, pageDetails);
  ...
  public ProductDTO deleteProduct(Long productId) {
    ...
    if (product.isEmpty()) throw new APIException("cannot find id with : " + productId);

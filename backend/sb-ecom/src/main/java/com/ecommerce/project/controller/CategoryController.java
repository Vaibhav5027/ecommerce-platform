...
public class CategoryController {
  ...
  ResponseEntity<CategoryResponse> getAllCategories(
      ...
      @RequestParam(
              name = "pageSize",
              defaultValue = CategoryApiConstants.PAGE_SIZE,
              required = false)
          Integer pageSize,
      @RequestParam(name = "sortBy", defaultValue = CategoryApiConstants.SORT_BY, required = false)
          String sortBy,
      @RequestParam(
              name = "orderBy",
              defaultValue = CategoryApiConstants.ORDER_BY,
              required = false)
          String orderBy) {

    CategoryResponse allCategories =
        categoryService.getAllCategories(pageNumber, pageSize, sortBy, orderBy);

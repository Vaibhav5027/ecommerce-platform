...
public class ProductController {
  ...
  ResponseEntity<ProductResponse> getAllProducts(
      ...
      @RequestParam(
              name = "pageSize",
              required = false,
              defaultValue = ProductApiConstants.PAGE_SIZE)
          Integer pageSize,
      @RequestParam(name = "sortBy", required = false, defaultValue = ProductApiConstants.SORT_BY)
          String sortBy,
      @RequestParam(name = "orderBy", required = false, defaultValue = ProductApiConstants.ORDER_BY)
          String orderBy) {
    ProductResponse allProducts =
        productService.getAllProducts(pageNumber, pageSize, sortBy, orderBy);
  ...
  ResponseEntity<ProductResponse> getProductsByCategory(
    ...
    ProductResponse productResponse =
        productService.productsByCategory(categoryId, pageNumber, pageSize, sortBy, orderBy);
    return ResponseEntity.ok(productResponse);
  }

  @GetMapping("/public/products/keyword/{keyword}")
  ResponseEntity<ProductResponse> getProductByKeyword(
    ...
    ProductResponse response =
        productService.searchByKeyword(keyword, pageNumber, pageSize, sortBy, orderBy);
  ...
  ResponseEntity<ProductDTO> updateProductImage(
